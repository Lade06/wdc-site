...
import hairdressing from "../Assets/hair.jpeg";
 ...
 import textile from "../Assets/textile1.jpeg"
//  import adult from "../Assets/adult1.jpeg"
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-3 mt-5">
            ...
            <div className="text-center mt-2">
              ...
              <p>
                Read more about the course <span className="click-here">here</span>
              </p>
            </div>
          </div>
          <div className="col-md-3 mt-5">
          ...
          <div className="col-md-3 mt-5">
            <img src={hairdressing} alt="" width={"100%"}height={"70%"}  />
            <div className="text-center mt-2">
              <big>
        ...
        <div className="row">
          <div className="col-md-3 mt-5">
            <img src={catering} alt="" width={"100%"} height={"45%"}  />
            <div className="text-center mt-2">
              <big>
          ...
          <div className="col-md-3 mt-5">
            <img src={sewing} alt="" width={"100%"} height={"45%"} />
            <div className="text-center mt-2">
              <big>
          ...
          <div className="col-md-3 mt-5">
            <img src={photography} alt="" width={"100%"} height={"45%"}  />
            <div className="text-center mt-2">
              <big>
                <b>Photography</b>
              </big>
          ...
          <div className="col-md-3 mt-5">
            <img src={textile} alt="" width={"100%"} height={"45%"} />
            <div className="text-center mt-2">
              <big>
                <b>Textile Design</b>
              </big>
